...
public class TreeNode extends Node {
    ...
    private static String sqlGetUserProps = 
        "SELECT key_column, value_column FROM node_props WHERE uuid = ? AND type_column = 'u'";
    ...
    private static String sqlGetSysProps = 
        "SELECT key_column, value_column FROM node_props WHERE uuid = ? AND type_column = 's'";
    ...
    private static String sqlCheckRootExists = 
        "SELECT COUNT(*) as count FROM node_props WHERE uuid = ? AND type_column = 's' AND key_column = 'type'";
    ...
    private static String sqlFindChildren = 
        "SELECT uuid FROM node_props WHERE type_column = 's' AND key_column = 'parent' AND value_column = ?";
    ...
    private static String sqlFindAllTreeNodes = 
        "SELECT DISTINCT uuid FROM node_props WHERE type_column = 's' AND key_column = 'type' AND value_column = 'tree'";
