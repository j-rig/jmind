...
public class CaptiansLog extends JFrame {
    ...
    private void showScriptRunner() {
        ...
        // For log app, pass the current log's UUID if one is loaded
        String uuid = (currentLog != null) ? currentLog.getUuid() : null;

        ScriptRunnerDialog.showDialog(this, conn, uuid, () -> {
